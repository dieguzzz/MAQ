...
class StationPositionEditorModal extends StatefulWidget {
  ...
  @override
  State<StationPositionEditorModal> createState() => _StationPositionEditorModalState();
}

class _StationPositionEditorModalState extends State<StationPositionEditorModal> {
  ...
  Widget build(BuildContext context) {
    ...
    return PopScope(
      canPop: !_hasChanges, // Solo permitir salir sin confirmación si no hay cambios
            ...
            children: [
              ...
              if (isEdited)
                Container(
                  ...
                  decoration: BoxDecoration(
                    color: MetroColors.energyOrange.withOpacity(0.2),
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  Row(
                    children: [
                      Icon(Icons.edit_location, size: 16, color: MetroColors.blue),
                    ...
                    children: [
                      Expanded(
                        child: OutlinedButton.icon(
                          onPressed: () {
                            final text = "'${widget.station.id}': [${_latitude.toStringAsFixed(6)}, ${_longitude.toStringAsFixed(6)}]";
                      ...
                      if (isEdited)
                        Expanded(
                          child: OutlinedButton.icon(
                            onPressed: () {
                              _positionEditor.resetPosition(widget.station.id);
  ...
  Future<bool> _showExitConfirmation(BuildContext context) async {
    return await showDialog<bool>(
      ...
      builder: (dialogContext) => AlertDialog(
        ...
        content: const Text('Has realizado cambios en las coordenadas. ¿Deseas descartarlos y cerrar?'),
        actions: [
          TextButton(
