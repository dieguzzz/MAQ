...
class SimulatedTimeService extends ChangeNotifier {
  static final SimulatedTimeService _instance = SimulatedTimeService._internal();
  ...
  void _updateSimulatedTime() {
    ...
    final simulatedElapsedSeconds = (realElapsed * simulatedSecondsPerRealSecond).round();
    _simulatedTime = _baseRealTime.add(Duration(seconds: simulatedElapsedSeconds));
